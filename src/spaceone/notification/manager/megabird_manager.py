...
class MegabirdManager(BaseManager):
    ...
    def request_send_sms(self, title, notification_type, body, receivers, **kwargs):
        self.megabird_connector.request_send_message(title, notification_type, body, receivers, **kwargs)
